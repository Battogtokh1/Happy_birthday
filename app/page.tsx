...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0b0b12] via-[#120818] to-[#050308] text-white">
                ...
                <div className="p-8 border-4 border-pink-200 rounded-xl bg-gradient-to-br from-white to-pink-50">
                  ...
                  <div className="border-t-2 border-pink-200 pt-4 mb-4">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Өнөөдөр бол чиний минь энэ хорвоод мэндэлсэн гайхалтай тэр нэгэн өдөр. Чамдаа төрсөн өдрийн мэнд хүргэе
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-6 pt-4 border-t-2 border-pink-200">
                    ...
                    {/* Tooltip мэдэгдэл - үргэлж харагдана */}
                      <span className="absolute -right-20 bg-pink-500 text-white text-[10px] px-2 py-1 rounded whitespace-nowrap shadow-lg animate-pulse">
                        Энд дарна шүү! ✨
                      </span>
                  </div>
                </div>
